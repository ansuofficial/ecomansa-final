...
const showMore = document.querySelector(".stories-show-more");
const otherPost = document.querySelector(".other-post");

const handleShow = () => {
  otherPost.classList.toggle("other-post"),
    showMore.classList.add("other-post");
};

showMore.addEventListener("click", handleShow);